...
function SynthwaveUI:Create(title, accentColor)
    ...
    local avatarImage = Create("ImageLabel")({
        ...
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
        Image = Players:GetUserThumbnailAsync(LocalPlayer.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size352x352),
    ...
    -- Improved dragging implementation for reliable dragging in Roblox
